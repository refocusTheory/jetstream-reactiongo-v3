...
use Modules\ConnectMail\Http\Controllers\ConnectMailController;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
// Main Page Route
//Route::get('/', [DashboardController::class, 'blank'])->name('dashboard');
...
//     Route::get('test', [ConnectMailController::class, 'setClient'])->name('dashboard-test');
...
//     Route::get('knowledge-base/category', [PagesController::class, 'kb_category'])->name('page-knowledge-base-cat');
