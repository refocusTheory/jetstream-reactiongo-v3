...
class S3ConfigRepository implements ConfigRepository
{
    /**
     * LFM Route prefix
    ...
    {
        if (\Auth::id() == 1 ) {
            return ['Blueprint','Jetstream','MyDrive'];
        }else{
           return ['MyDrive','Jetstream'];
        }
    ...
    public function getLeftPath(): ?string
    {
        if (\Auth::id() == 1 ) {
            ...
            return \Auth::id();//null;//return 'users/'.\Auth::id().'/';
        }
    ...
    public function getRightPath(): ?string
    {
        if (\Auth::id() == 1 ) {
            ...
            return null;//\Auth::id();//null;// return 'users/'.\Auth::id();
        }
     ...
     * !!!! RESTRICT ACCESS FOR NON ADMIN MyDrive !!!!
     *
     * @return array
     */
